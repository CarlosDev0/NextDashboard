...
const EmpleadoProfile = ({ empleado }) => {
    const [selectedOC, setSelectedOC] = useState<IPurchaseOrder | undefined>(undefined);
    ...
    useEffect(() => {
        if (selectedOC) {
            const timer = setTimeout(() => { setSelectedOC(undefined) }, 4000)
    ...
    return (
        ...
        <div className="profile">
            ...
            <div className="detail">
                <button className="buttonDetail" type="submit" onClick={() => showDetails(empleado.cedula)}>Details</button>
